...
이번 QA 실행(최초 실행 + D-1/D-2 재검증 + FONT-01~10 재검증 + RESP-01~24·FONT-11~15 재검증 + FONT-09 최종 재검증 + Button·Chip-선택 미리보기 카드 실측 + 파일 저장 KEY-01~04 부분 실행 + 메모 기능·SourceLink 스킴 검사·FONT-16, 총 여덟 차례)을 위해 임시로 만든 것들이며, **매번 작업 종료 시 삭제**했다.
